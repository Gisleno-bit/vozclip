...
Efe nueve, corregir una palabra: pulsa, di el cambio, y pulsa otra vez.
...
class HUD:
    ...
    def _insertar_dictado(self, reconocido: str) -> None:
        ...
        if self.ajustes.get("correccion", {}).get("recordatorio", True) \
            ...
            recordatorio = " Efe nueve para corregir una palabra."
        frase = listo.strip()
    ...
    def accion_corregir(self) -> None:
        ...
        if self.dictando and self.correccion is not None:
            self.servicio_dictado.detener()       # segunda pulsación: procesar
            return
        ...
        if modo == "numerado":
            ...
            self.voz.hablar(
                "Dime el cambio. Por ejemplo, cambia casa por cosa. Después pulsa efe nueve."
            )
            self.servicio_dictado.empezar()
    ...
    def _fase_elegir_numero(self) -> None:
        ...
        self.voz.hablar(
            ...
            + " ¿Cuál cambio? Di el número, o del dos al cuatro. Después pulsa efe nueve."
        )
        self.servicio_dictado.empezar()
    ...
    def _fase_dictar_nueva(self, elegidas: list) -> None:
        ...
        self.voz.hablar(f"{que}. Dime la palabra correcta, o di borrar. Después pulsa efe nueve.")
        self.servicio_dictado.empezar()
